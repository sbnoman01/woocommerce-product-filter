 ...
 * @subpackage Coastal_Windows/public
 */
...
class Coastal_Windows_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name.'swiper', plugin_dir_url( __FILE__ ) . 'css/swiper-bundle.min.css', array(), time(), 'all' );
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/coastal-windows-public.css', array(), time(), 'all' );
